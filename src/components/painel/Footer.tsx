...
export function Footer({ whatsappPhone }: { whatsappPhone: string }) {
  ...
  return (
    <div className="mt-10 rounded-card border border-ink-200 bg-white p-6 shadow-card">
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
        ...
        <div className="text-center sm:text-left">
          <h3 className="mb-2 text-sm font-semibold text-ink-900">Contato</h3>
          <p className="mb-1 flex items-center justify-center gap-2 text-sm text-ink-600 sm:justify-start">
            <Phone className="h-4 w-4 text-brand-600" strokeWidth={1.75} />
            {formatPhoneBR(whatsappPhone)}
          </p>
          <p className="mb-1 flex items-center justify-center gap-2 text-sm text-ink-600 sm:justify-start">
            <Mail className="h-4 w-4 text-brand-600" strokeWidth={1.75} />
            contato@transporte3e.com.br
          </p>
          <p className="flex items-center justify-center gap-2 text-sm text-ink-600 sm:justify-start">
